                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {                            
                            ...
                            if (e.getErrorCode() == EMError.CALL_REMOTE_OFFLINE) {
                                st2 = getResources().getString(com.hyphenate.easeui.R.string.The_other_is_not_online);
                            } else if (e.getErrorCode() == EMError.USER_NOT_LOGIN) {
                                st2 = getResources().getString(com.hyphenate.easeui.R.string.Is_not_yet_connected_to_the_server);
                            } else if (e.getErrorCode() == EMError.INVALID_USER_NAME) {
                                st2 = getResources().getString(com.hyphenate.easeui.R.string.illegal_user_name);
                            } else if (e.getErrorCode() == EMError.CALL_BUSY) {
                                st2 = getResources().getString(com.hyphenate.easeui.R.string.The_other_is_on_the_phone);
                            } else if (e.getErrorCode() == EMError.NETWORK_ERROR) {
                                st2 = getResources().getString(com.hyphenate.easeui.R.string.can_not_connect_chat_server_connection);
                            }
...
//                        }
    ...
    protected void saveCallRecord() {
        ...
        String st1 = getResources().getString(com.hyphenate.easeui.R.string.call_duration);
        String st2 = getResources().getString(com.hyphenate.easeui.R.string.Refused);
        String st3 = getResources().getString(com.hyphenate.easeui.R.string.The_other_party_has_refused_to);
        String st4 = getResources().getString(com.hyphenate.easeui.R.string.The_other_is_not_online);
        String st5 = getResources().getString(com.hyphenate.easeui.R.string.The_other_is_on_the_phone);
        String st6 = getResources().getString(com.hyphenate.easeui.R.string.The_other_party_did_not_answer);
        String st7 = getResources().getString(com.hyphenate.easeui.R.string.did_not_answer);
        String st8 = getResources().getString(com.hyphenate.easeui.R.string.Has_been_cancelled);
        switch (callingState) {
        case NORMAL:
        ...
        case VERSION_NOT_SAME:
            txtBody = new EMTextMessageBody(getString(com.hyphenate.easeui.R.string.call_version_inconsistent));
            break;
        default:
